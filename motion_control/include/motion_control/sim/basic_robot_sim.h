 ...
 * @brief A class for basic robot simulation
 * @version 0.1
 * @date 2020-05-24
 ...
 */
class BasicRobotSim : public hardware_interface::RobotHW
{
    public:
        /**
         * @brief Construct a new Basic Robot Sim instance
         */
        explicit BasicRobotSim();
        /**
         * @brief A virtual function for reading from front steering simulation
         * @param time - Current time
         * @param period - Max period allowed
         */
        virtual void read(const ros::Time& time, const ros::Duration& period) override;
        /**
         * @brief A virtual function for writing to front steering simulation
         * @param time - Current time
         * @param period - Max period allowed
         */
