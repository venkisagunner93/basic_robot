...
void BasicRobotBase::read(const ros::Time& time, const ros::Duration& period)
{
    hardware_interface::RobotHW::read(time, period);
}

void BasicRobotBase::write(const ros::Time& time, const ros::Duration& period) 
{
